...
# MYNOTE: the conv+batchnorm that could fuse together at inference time
...
# MYNOTE: the linear+batchnorm that could fuse together at inference time
...
# MYNOTE: repconv of size 3x3, in out same channel
...
# MYNOTE: channel mixer for block
# divide to 4 chunks and process separatedly
...
# MYNOTE: token mixer used in downsample
# stride=2; channel size*2
...
"""
MYNOTE
RepNextStem -> [RepNextStage=(Downsample->MetaNeXtBlocks), ...] -> RepNextClassifier head
"""
class RepNext(nn.Module):
    ...
    @torch.no_grad()
    def fuse(self):     # MYNOTE: for reparam
...
# MYNOTE: 13.3M, 81.2 before distill
@register_model
