...
REGISTERED_DCAE_MODEL: dict[str, tuple[Callable, Optional[str]]] = {
    ...
    "st-dc-ae-f32t4c32-chunked-causal-40-0.4": (st_dc_ae_f32t4c32_chunked_causal, None),
    "st-dc-ae-f32t4c32-chunk40-spatial-tile-512": (st_dc_ae_f32t4c32_chunked_causal, None),
}
