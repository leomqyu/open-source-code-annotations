...
class VideoDataConfig(DataConfig):
    data_dir: Dict[str, str] = field(default_factory=lambda: {"wan": "data/wan"})
...
class ModelVideoConfig(ModelConfig):
    ...
    mhla_adjust: bool = False
    rope_after: bool = False
    rms_output: bool = False
...
class WanModelConfig(BaseConfig):
    ...
    rope_after: bool = False
    without_rope: bool = False
    power: float = 1.0
    ffn_type: str = "mlp"
    rms_output: bool = False  # for mhla
    norm_output: bool = True  # for mhla
    mhla_adjust: bool = False
...
class TrainingConfig(BaseConfig):
    ...
    # reconstruct loss
    reconstruct_loss: bool = False
    reconstruct_loss_type: str = "huber"
    huber_c: float = 0.001
    # other
    vis_grad: bool = False
    extra: Any = None
...
@dataclass
class WanVideoConfig(SanaVideoConfig):
    model: WanModelConfig
