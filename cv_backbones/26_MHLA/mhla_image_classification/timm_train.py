...
from models import timm_registers   # MYNOTE: by the import statement, already got the model registered 
...
group.add_argument('--resplit', action='store_true', default=False,
                   help='Do not randoargs.modelm erase first (clean) augmentation split')
