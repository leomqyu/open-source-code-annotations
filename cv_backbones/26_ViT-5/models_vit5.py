...
class Attention(nn.Module):
    ...
    def __init__(self, dim, num_heads=8, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0., flash=True,
        ...
        # MYNOTE: diff theta: default theta is 10000, reg_theta=100 in the implementation
        # rope_size / pt_seq_len: input H /W
    ...
    def forward(self, x):
        ...
        if self.rope is not None:   # MYNOTE: split into 3 parts: 1* cls tok, num_reg * reg_tok, rest is patch tok
